...
export const PROJECTS = [
  {
    ...
    name: { en: 'Wetland Restoration — Deep Bay', zh: '湿地恢复 — 后海湾' },
    ...
    specs: [
      {
        ...
        role: { en: 'Continuous return of water-quality, weather and pond conditions over 4G — restoration is evaluated between site visits, not from periodic samples.', zh: '通过 4G 持续回传水质、气象与塘况——恢复成效在两次实地探访之间即可评估，无需依赖周期性采样。' },
      },
      {
        tag: 'HW-02',
  ...
  },
  {
    ...
    name: { en: 'Mothbox — Open Trap Cam', zh: 'Mothbox — 开源诱虫相机' },
    ...
    specs: [
      {
        tag: 'HW-01',
        label: { en: 'reCamera', zh: 'reCamera' },
        role: { en: 'Edge AI identifies and counts moths on the device — manual image review is reduced.', zh: '端侧 AI 在设备上完成蛾类识别与计数，大幅减少人工翻图。' },
      },
      {
        tag: 'HW-02',
  ...
  },
  {
    ...
    link: '',
    name: { en: 'Mothbox — Peru', zh: 'Mothbox — 秘鲁' },
  ...
  },
  {
    ...
    stats: [{ val: { en: 'Open to Collaborate', zh: '开放共建' }, lbl: { en: 'Status', zh: '状态' } }],
    link: '',
    name: { en: 'Mothbox — Yellowstone', zh: 'Mothbox — 黄石' },
    status: { en: 'Planned', zh: '规划中' },
  ...
  },
  {
    ...
    link: '',
    name: { en: 'Olfactory Sensor', zh: '嗅觉传感器' },
  ...
  },
  {
    ...
    stats: [{ val: { en: 'Open to Collaborate', zh: '开放共建' }, lbl: { en: 'Status', zh: '状态' } }],
    link: '',
    name: { en: 'CollarID — MIT', zh: 'CollarID — MIT' },
